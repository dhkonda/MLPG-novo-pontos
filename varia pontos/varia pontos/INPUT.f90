SUBROUTINE INPUT(NNOC,NDOM,MAXSUP,NCANT,MON,NPG,E,NI,T,CARGA,NPRES,ADP,NPT,PSUPG,TMON,D,ARQS,NPSUP,ALFA,FAT)  
USE ALOCAVEIS !X,Y,C,NO,CA,NOPRES,TIPOPRES,VPRES
IMPLICIT NONE

CHARACTER*20:: ARQUENT,ARQS
LOGICAL:: EXISTE
INTEGER:: I,J,NNOC,NDOM,MAXSUP,NCANT,MON,NPG,NPRES,ADP,NPT,PSUPG,TMON,NPSUP,ADPFAKE
REAL*8::E,NI,T,CARGA,D,ALFA,FAT
...
READ(1,*)  NPG,E,NI,T,CARGA,NPRES,ADPFAKE  

DO i =1, 4
    READ(1,*)
END DO

READ(1,*)  PSUPG,ALFA,FAT
...
DO I=NNOC+1,NPT
	READ(1,*) NO(I),X(I),Y(I)
ENDDO
!calculo do modulo de rigidez da placa 
D=(E*T**3.d0)/(12.d0*(1.-(NI**2.d0)))
