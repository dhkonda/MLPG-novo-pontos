...
!#################################################################################
SUBROUTINE MATRIZES_FIXAS(D,Ni,MATRIZD1,T,CARGA,MATRIZR1,MATRIZR2,MATRIZD2,MATRIZD3,MATRIZD4,MATRIZD5,MATRIZD7)
IMPLICIT NONE
...
!montagem da matriz D7
MATRIZD7=0.D0
MATRIZD7(1,1)=D
MATRIZD7(1,2)=D*Ni
MATRIZD7(2,3)=0.5D0*D*(1.D0-Ni)
MATRIZD7(3,4)=0.5D0*D*(1.D0-Ni)*LAMB**2
