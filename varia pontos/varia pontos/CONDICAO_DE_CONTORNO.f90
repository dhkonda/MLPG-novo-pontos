SUBROUTINE CONDICAO_DE_CONTORNO(ALFA,ALFA2,i,NNOC,C,NCANT,iDLMENOR,NO,NPT,iDC,X,Y,NPSUP,MON,TMON,KGLOBAL,FGLOBAL,VALORP,TIPOPRES,VCANT,SHAPE)
    IMPLICIT NONE

INTEGER:: i,J,K,NNOC,NCANT,NPT,NPSUP,MON,TMON,SHAPE
...
IF(SHAPE.EQ.1)THEN
            CALL MINIMOS_QUADRADOS(i,X(i),Y(i),X,Y,NPSUP,FG,NPT,MON,TMON,DG,AiB,dAixB,dAiyB,AidBx,AidBy,Fi,dFix,dFiy,ddFiX,ddFiY,ddFiXY) !,AiB,dAiXB,dAiYB,AidBX,AidBY
