...
SUBROUTINE MONTA_SUPORTE_2(XT,YT,X,Y,NPT,PSUPG,NO,FG,DG)
USE TIPO
IMPLICIT NONE
...
!write(*,*) 'o ponto base foi EXCLUIDO do suporte'
DO i=2,PSUPG+1          !aqui eu exclui o ponto do proprio suporte
    FG(i-1)=DORD(i)%ORDEM2
    DG(i-1)=DORD(i)%VALOR
ENDDO
 


END SUBROUTINE MONTA_SUPORTE_2
