...
!##################################################################################
SUBROUTINE OUTPUT(ARQS,NCANT,iDC,XC,YC,Cadj,NNOC,NDOM,NPG,ADP,NPT,DESL,NO,PSUPG)
IMPLICIT NONE

CHARACTER*20:: ARQS
INTEGER::MON,NCANT,i,NNOC,NDOM,NPG,ADP,NPT,PSUPG
...
INTEGER,DIMENSION(NPT)::NO
 ...
 WRITE (2,41) NNOC,NDOM,NCANT,NPG,ADP,PSUPG
 41 FORMAT (/,10X,'N DE PONTOS NO CONTORNO =',13X,I3,//,10X,'N DE PONTOS INTERNOS =',17X,I4,//,10X,'N DE CANTOS =',&
    24X,I3,//,10X,'N DE PONTOS DE GAUSS =',16X,I3,//,10X,'PONTOS ADICIONAIS NA INTERPOLACAO DO SUPORTE LOCAL =',I3,//,10X,&
    'QDE DE PONTOS NO SUPORTE DO PONTO DE GAUSS =',9X,I3,///,25X,'GEOMETRIA DA PLACA',/,5X,'CANTO',5X,'COORD X',5X,&
    'COORD Y',5X,'CANTO ANTERIOR',5X,'CANTO POSTERIOR')
...
write(2,500)IDIA,IMES,IANO,IHORA,IMIN,ISEC,I100TH

500 format(//,5X,74('*'),/,5X,1('*'),52X,1('*'),2X,'DATA: ',I2.2,1H-,I2.2,1H-,I4.4,1X,1H*,/,5X,1H*,10X, 'Danilo &
Hiroshi Konda',22X,1H*,19X,1H*,/,5X,1H*10X,'Prof. Jose Antonio Fontes Santiago',8X, 1H*,2X,'HORA: &
',I2.2,1H:,I2.2,1H:,I2.2,1H:,I2.2,1H*,/,5X,1H*,52X, 1H*,19X,1H*,/,5X,74('*'))
